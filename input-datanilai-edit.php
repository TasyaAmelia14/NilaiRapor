...
<form action="input-datanilai-edit.php" method="POST">
    ...
    <input class="form-control" value="<?php echo $row["nis"]; ?>" readonly type="number" name="nis" placeholder="Ex. 121007778" /><br>

    <label for="namalengkap"> Nama Lengkap :</label>
    <input class="form-control" value="<?php echo $row["namalengkap"]; ?>" type="text" name="namalengkap" placeholder="Ex. Tasya" /><br>
